...
const [userData, setUserData] = useState({
  ...
  const handleModifyClick = () => {
    setIsEditMode(true); // Enable the edit mode for modifying user data
  };
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12 mx-auto mb-5">
              ...
              <div className="tab-container">
                      ...
                      <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                        <input
                          ...
                          value={userData ? userData.custno : "Cust No"}
                           ...
                           // Disable editing when not in editable mode
                        />
                      </div>
                      <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                        <input
                ...
                <div className="col-12 text-center mt-3">
                  <button type="submit" className="btn btn-primary">{isEditMode ? "Submit" : "Edit"}
                  </button>
                </div>
              </div>
                  </form>
